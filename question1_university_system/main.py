...
# Faculty
prof = Professor("Dr. Samith", 50, "samith@uni.edu", "F001")
lecturer = Lecturer("Dr. Kasun", 40, "kasun@uni.edu", "F002")
ta = TeachingAssistant("Shehan", 28, "shehan@uni.edu", "F003")
cs_dept.assign_faculty(prof)
cs_dept.assign_faculty(lecturer)
cs_dept.assign_faculty(ta)

# Students
ug_student = UndergraduateStudent("Dilon", 20, "Dilon@student.uni.edu", "S001")
grad_student = GraduateStudent("Kaveesha", 24, "Kaveesha@student.uni.edu", "S002")
...
ml.enroll_student(grad_student)  # should fail due to missing prerequisite
